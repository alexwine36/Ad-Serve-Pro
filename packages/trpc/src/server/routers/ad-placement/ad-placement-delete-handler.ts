...
export const adPlacementDeleteHandler = async ({ ctx, input }: AdPlacementDeleteOptions) => {
...
export type AdPlacementDeleteResponse = Awaited<ReturnType<typeof adPlacementDeleteHandler>>;