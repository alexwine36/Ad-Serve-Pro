...
delete: authedProcedure.input(AdPlacementDeleteSchema).mutation(adPlacementDeleteHandler),

update: authedProcedure.input(AdPlacementUpdateSchema).mutation(adPlacementUpdateHandler),

create: authedProcedure.input(AdPlacementCreateSchema).mutation(adPlacementCreateHandler),

getOne: authedProcedure.input(AdPlacementGetOneSchema).query(adPlacementGetOneHandler),

getAll: authedProcedure.input(AdPlacementGetAllSchema).query(adPlacementGetAllHandler),
});