...
export const adPlacementGetAllHandler = async ({ ctx, input }: AdPlacementGetAllOptions) => {
...
export type AdPlacementGetAllResponse = Awaited<ReturnType<typeof adPlacementGetAllHandler>>;