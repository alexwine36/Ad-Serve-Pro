...
export const adPlacementUpdateHandler = async ({
  ctx,
  input,
}: AdPlacementUpdateOptions) => {
...
export type AdPlacementUpdateResponse = Awaited<
  ReturnType<typeof adPlacementUpdateHandler>
>;
