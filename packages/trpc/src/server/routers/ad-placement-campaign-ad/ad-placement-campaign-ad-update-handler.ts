...
export const adPlacementCampaignAdUpdateHandler = async ({ ctx, input }: AdPlacementCampaignAdUpdateOptions) => {
...
export type AdPlacementCampaignAdUpdateResponse = Awaited<ReturnType<typeof adPlacementCampaignAdUpdateHandler>>;